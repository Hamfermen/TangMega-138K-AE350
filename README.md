...
![Необходимый для прошивки Type-C порт](images/fig1.jpg)

Также для успешной прошивки нужно включить свитчи на плате следующим образом:

![Правильное включение свитчей](images/fig2.jpg)
...
![Кнопка POWER](images/fig3.jpg)

После чего при пустой прошивке на ПЛИС загорится светодиод POWER.

![Светодиоды POWER, READY, DONE](images/fig4.jpg)
...
![Образец пунктов, которые нужно заполнить](images/fig5.jpg)
...
![Настройки перед созданием проекта](images/fig6.jpg)

![Настройки проекта](images/fig7.jpg)
...
![Оптимизация билда](images/fig10.jpg)
...
![Уровень дебагинга](images/fig11.jpg)
...
![Настройки разного](images/fig12.jpg)
...
![Настройка LdSaG](images/fig13.jpg)
...
![Подключение UART](images/fig20.jpg)

![Подключение GPIO](images/fig21.jpg)
...
![Настройка PLL](images/fig22.jpg)
...
![Ресурсы, потраченные на прошивку](images/fig23.jpg)
...
![Прошивка AE350](images/fig24.jpg)

![Прошивка ПЛИС](images/fig25.jpg)
...
![Очистка flash](images/fig26.jpg)
