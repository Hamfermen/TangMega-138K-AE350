...
<img src="images/fig1.png" alt="Необходимый для прошивки Type-C порт" width="70%">

Также для успешной прошивки нужно включить свитчи на плате следующим образом:

<img src="images/fig2.png" alt="Правильное включение свитчей" width="70%">
...
<img src="images/fig3.png" alt="Кнопка POWER" width="70%">

После чего при пустой прошивке на ПЛИС загорится светодиод POWER.

<img src="images/fig4.png" alt="Светодиоды POWER, READY, DONE" width="70%">
...
<img src="images/fig5.png" alt="Образец пунктов, которые нужно заполнить" width="70%">
...
<img src="images/fig6.png" alt="Настройки перед созданием проекта" width="70%">
<img src="images/fig7.png" alt="Настройки проекта" width="70%">
...
<img src="images/fig10.png" alt="Оптимизация билда" width="70%">
...
<img src="images/fig11.png" alt="Уровень дебагинга" width="70%">
...
<img src="images/fig12.png" alt="Настройки разного" width="70%">
...
<img src="images/fig13.png" alt="Настройка LdSaG" width="70%">
...
<img src="images/fig14.png" alt="Настройка линковщика" width="70%">

Теперь вы можете билдить проект, нажав левой кнопкой мыши по папке проекта и выбрав молоток на панели сверху.

<img src="images/fig15.png" alt="Билдинг проекта" width="70%">
...
<img src="images/fig16.png" alt="Включение DRSM" width="70%">

Далее в `Place & Route` настройте пункты `Place` и `Route`, как показано ниже:

<img src="images/fig17.png" alt="Настройка Place" width="70%">
<img src="images/fig18.png" alt="Настройка Route" width="70%">

Также переопределите некоторые пины в `Dual-Purpose Pin`. Если вы не переопределяете JTAG, настройте как на рисунке:

<img src="images/fig19.png" alt="Определение пинов" width="70%">
...
<img src="images/fig20.png" alt="Подключение UART" width="70%">
<img src="images/fig21.png" alt="Подключение GPIO" width="70%">
...
<img src="images/fig22.png" alt="Настройка PLL" width="70%">
...
<img src="images/fig23.png" alt="Ресурсы, потраченные на прошивку" width="70%">
...
<img src="images/fig24.png" alt="Прошивка AE350" width="70%">
<img src="images/fig25.png" alt="Прошивка ПЛИС" width="70%">
...
<img src="images/fig26.png" alt="Очистка flash" width="70%">
